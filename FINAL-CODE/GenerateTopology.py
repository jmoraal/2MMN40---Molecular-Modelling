...
def createGrid(nrOfMolecules, boxSize):
    ...
    return rand #not actually random, name originates from earlier implementation
...
def findSize(approxSize, substance):
    ''' returns boxsizes so that all grid positions are filled for different substances'''
